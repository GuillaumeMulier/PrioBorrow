...
|-------------|-----------------------------------------------------------------------------|---------|
| #1	        | (randomized) AND ("dose arm" OR "multiple doses" OR "multiple dosage")	    | 1804    |
| #2	        | “dose ranging”	                                                            | 3044    |
...
Au final, on aurait 634 articles à examiner sur le titre.
...
- What are the practices for main outcome measures and their analysis in dose ranging studies in oncology?
- What is the usual size of these studies ?
...
- research article giving the results of a dose ranging trial in oncology

Exclusion criteria :

- methodological article (article describing new metehodologies or how to analyse a trial with an example of a trial but not the article where the trial is reported)
...
Analysis practices in dose-ranging trials.
...
Traditionally, drug developpment follows the same pattern: preclinical studies on in vitro models or animal models, phase I study to evaluate the maximal tolerated dose on healthy volunteers, phase II with first evaluation of efficacy, phase III for robust evaluation of efficacy through randomized trial leading to autorization to use the drug, and finally phase IV studies after autorizations to explore consequences of the use of the drug.
We are particularly interested in early phases of developpment of drug in oncology (phase I/II).
In oncology, drugs have significant adverse effects and thus no healthy volunteers are recruited.
Moreover, cytotoxic drugs have been analyzed with the assumption that the efficacy and the toxicity are monotonically inscreasing with the dose of the drug.
Therefore, the most toxic dose identified in phase I is assumed to be the most effective one which is studied in phase II.

But new therapeutics emerged (immunotherapies, target therapies, ...) that do not respect this assumption and we can have multiple doses with comparable efficacies but increasing toxicity.
...
Describe the main outcome measure of the trials (efficacy and/or toxicity) and how it is analyzed.
...
After removing duplicates from the research, 2 researchers will independently screen all articles on title and abstract to select articles that will be read entirely.
Full text will be retrieved and 2 independant researchers will assess if these articles fit the review and extract informations through a standardized form.
Disagreement will be resolved by consensus with a third reviewer.
A summary of the extracted data is available below:
...
Dr Guillaume Mulier, APHP, Department of Biostatistics and Medical Information, Saint-Louis hospital, Paris, France. Inserm U1153 team ECSTRRA, Paris, France.
Dr Lucie Biard, APHP, Department of Biostatistics and Medical Information, Saint-Louis hospital, Paris, France. Inserm U1153 team ECSTRRA, Paris, France.
Pr Vincent Levy, APHP, Clinical research unity, Avicenne hospital, Paris, France.
