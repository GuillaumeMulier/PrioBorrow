...
- $H_0:\pi_{eff}=0.15 ; \pi_{tox}=0.30$ soit $(0.08;0.07;0.22;0.63)$ ($R=0.21$)
- $H_1:\pi_{eff}=0.35;\pi_{tox}=0.20$ soit $(0.1;0.25;0.1;0.55)$ ($R=0.16$)
...
- 1 : Tout à $H_0$ -> $(0.08;0.07;0.22;0.63)$ ; $(0.08;0.07;0.22;0.63)$ ; $(0.08;0.07;0.22;0.63)$
- 2 : Tout à $H_1$ -> $(0.1;0.25;0.1;0.55)$ ; $(0.1;0.25;0.1;0.55)$ ; $(0.1;0.25;0.1;0.55)$
- 3 : Efficacité croissante à partir d'une efficacité moyenne ; toxicité croissante à partir de $<H_1$ -> $(0.05;0.2;0.1;0.65)$ ; $(0.1;0.25;0.1;0.55)$ ; $(0.15;0.3;0.1;0.45)$
- 4 : Efficacité croissante à partir d'une efficacité moyenne ; toxicité plateau -> $(0.05;0.2;0.1;0.65)$ ; $(0.1;0.25;0.15;0.5)$ ; $(0.15;0.3;0.1;0.45)$
- 5 : Efficacité avec plateau à $H_1$ ; toxicité avec plateau vers $H_1$ -> $(0.05;0.15;0.1;0.7)$ ; $(0.1;0.25;0.1;0.55)$ ; $(0.1;0.25;0.1;0.55)$
- 6 : Efficacité croissante à partir d'une efficacité moyenne ; toxicité croissante à partir d'une toxicité moyenne -> $(0.08;0.17;0.17;0.58)$ ; $(0.13;0.22;0.17;0.48)$ ; $(0.18;0.27;0.17;0.38)$
- 7 : Efficacité avec plateau $>H_1$ ; toxicité avec plateau à $H_0$ -> $(0.08;0.17;0.17;0.58)$ ; $(0.15;0.25;0.15;0.45)$ ; $(0.15;0.25;0.15;0.45)$
- 8 : Efficacité fortement croissante ; toxicité avec plateau $>H_1$ -> $(0.1;0.25;0.15;0.5)$ ; $(0.2;0.25;0.15;0.4)$ ; $(0.2;0.35;0.15;0.3)$
- 9 : Efficacité et toxicité croissantes, mais à des valeurs plus basses que $H_1/H_0$ -> $(0.03;0.07;0.12;0.78)$ ; $(0.05;0.1;0.15;0.7)$ ; $(0.07;0.13;0.18;0.62)$
- 10 : Efficacité et toxicité croissantes, à des valeurs encore moindres -> $(0.02;0.08;0.08;0.82)$ ; $(0.04;0.11;0.11;0.74)$ ; $(0.05;0.15;0.15;0.65)$

J'ai essayé d'avoir les scénarios 1 et 2 qui sont des contrôles, les scénarios 3 à 5 très efficaces et peu toxiques, les scénarios 6 à 8 très efficaces et très toxiques, et les scénarios 9 et 10 peu efficaces et peu toxiques.
...
- mBOP borrow-seq : idem que mBOP borrow, mais on ne partage la toxicité
...
- hierar : modèle hiérarchique (type celui de Schmidli) pour l'efficacité et la toxicité
