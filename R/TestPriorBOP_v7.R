...
# Auteur : G. Mulier                                                   #
# Créé le 21/05/2024, modifié le 04/06/2025                            #
# -------------------------------------------------------------------- #
...
if (FALSE) {
  ...
  SeuilIva4 <- c("t1" = 13, "n1" = 35, "t" = 27, "n" = 70, "alpha" = .3107, "puissance" = .8529, "a" = 1, "b" = 1, "Seuil" = .4, "Critere" = .5)
}
...
if (TRUE) {
  ...
  for (m in seq_len(length(Methodes))) {
    ...
    # Save results
    save(ResT, file = paste0("~/simu_priors/resultats_priors4_20250416_", m, ".RData"))
...
if (TRUE) {
  ...
  for (m in seq_len(length(Methodes))) {
    ...
    # Save results
    save(ResT, file = paste0("~/simu_priors/resultats_priors5_20250416_", m, ".RData"))
